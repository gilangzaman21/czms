...
$string = "<div class=\"panel panel-inverse\" data-sortable-id=\"table-basic-2\">
                        <div class=\"panel-heading\">
                            ...
                            <h4 class=\"panel-title\">".str_replace("_"," ",ucwords($table))." <?php echo \$button ?></h4>
                        </div>
...
if (mysql_num_rows($result2) > 0)
{
    while ($row1 = mysql_fetch_assoc($result2))
    {
        ...
        $string .= "\n\t    <div class=\"form-group\">
                <label for=\"".$row1["COLUMN_NAME"]."\">".str_replace("_"," ",strtoupper($row1['COLUMN_NAME']))." <?php echo form_error('".$row1["COLUMN_NAME"]."') ?></label>
        ...
        {
        $string .= "\n\t    <div class=\"form-group\">
                <label for=\"".$row1["DATA_TYPE"]."\">".str_replace("_"," ",strtoupper($row1['COLUMN_NAME']))." <?php echo form_error('".$row1["COLUMN_NAME"]."') ?></label>
