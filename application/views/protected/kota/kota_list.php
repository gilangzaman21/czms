...
<div class="col-md-12">
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Kota</h4>
        </div>
        <div class="row">
            <div style="margin:10px;padding:10px;">
                <?php echo anchor(site_url('protected/kota/create'),'Tambah Data', 'class="btn btn-primary"'); ?>
            </div>
        </div>
    ...
    if ($("#data-table").length !== 0) {
        if ($(window).width() >= 767) {
            var e = $("#data-table").DataTable({
                ajax: "<?php echo base_url('protected'); ?>/kota/getJson",
