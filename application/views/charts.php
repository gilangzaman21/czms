...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/charts') ?>/jquery-1.4.4.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/charts') ?>/js/highcharts.js"></script>
</head>
<body>
